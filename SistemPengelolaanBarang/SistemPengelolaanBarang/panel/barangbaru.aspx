<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barangbaru.aspx.cs" Inherits="SistemPengelolaanBarang.panel.barangbaru" %>
...
<body>
    <div class="container-fluid">
		...
		<div class="row ">
			...
			<div class="col-lg-10">
                <div class="info-page">
					<h5 class="ml-2 mt-2"><strong><i>&nbsp<i class="fa fa-suitcase"></i> Input Data Baru </i></strong></h5>
					<hr/>
				</div>
                <div class="row py-2">
                    ...
                    <div class="col-lg-12">
                        <div class="text-right">
						    <asp:Button ID="btnLogin" runat="server" Text="TAMBAH" OnClick="btnInput_Click" cssClass="btn btn-success"/>
					    </div>
                    </div>
                </div>
            </div>
