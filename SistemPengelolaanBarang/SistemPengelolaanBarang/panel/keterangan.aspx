<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="keterangan.aspx.cs" Inherits="SistemPengelolaanBarang.panel.keterangan" %>
      ...
      <div class="col-lg-10">
        <div class="info-page">
            ...
            <div class="row nopadding">
                <asp:LinkButton ID="info" runat="server" CssClass="btn btn-success" OnClick="info_Click">Tambah Data Kegiatan Baru</asp:LinkButton>
            </div><br />
        </div>
          <asp:GridView runat="server" AllowPaging="true" ID="gvKegiatan" AutoGenerateColumns="false" CssClass="table mt-2"  >
            <Columns>
