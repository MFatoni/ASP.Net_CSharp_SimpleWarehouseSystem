<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="laporan.aspx.cs" Inherits="SistemPengelolaanBarang.panel.laporan" %>
    ...
    <div class="container-fluid">
		...
		<div class="row ">
			...
			<div class="col-lg-10">
				...
				<h6 class="ml-2 mt-4"><strong><i>&nbsp Daftar Barang </i></strong></h6><br />
                <asp:GridView runat="server" AllowPaging="true" ID="gvBarang" AutoGenerateColumns="false" CssClass="table"  >
                    <Columns>
                ...
                <h6 class="ml-2 "><strong><i>&nbsp Daftar Kegiatan </i></strong></h6><br />
                <asp:GridView runat="server" AllowPaging="true" ID="gvKegiatan" AutoGenerateColumns="false" CssClass="table"  >
                <Columns>
                    <asp:TemplateField HeaderText="No">
                        <ItemTemplate>
                            <%# ((GridViewRow)Container).RowIndex + 1%>
                    ...
                    <asp:BoundField DataField="id_brg" Visible="false" />
                    <asp:BoundField HeaderText="Jenis Kegiatan" DataField="jkegiatan" />
                    <asp:BoundField HeaderText="Jumlah Barang" DataField="jumlah" />
                    <asp:BoundField HeaderText="Tanggal" DataField="tanggal"/>
                    <asp:BoundField HeaderText="Penanggung Jawab" DataField="pj"/>
                </Columns>
                <HeaderStyle CssClass="thead-dark text-center" />
            </asp:GridView>
			</div>
